	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="templateadmin/vendors/images/deskapp-logo.svg" alt="">
				</a>
			</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="templateadmin/vendors/images/login-page-img.png" alt="">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Login To An-Nahdiyah</h2>
						</div>
						<form>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										...
										-->
										<a class="btn btn-primary btn-lg btn-block" href="/home">Sign In</a>
									</div>
